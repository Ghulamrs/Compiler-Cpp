...
// own code in the function's table: on the Itanium targets a catch-all row
// whose pad calls std::terminate as clang's does. The throw from ~Loud never reaches the
